...
At [SMU](https://beetlesite.netlify.app/professional/education/#singapore-management-university), we are all required to have our own name tents in order for the professors to mercilessly vaporize us by addressing us when we haven't studied the content (for legal reasons, that is a joke). It's quite common for people to use name tents that have been handed out as part of merchandise that comes from school events with freebies, such as Orientation camps. However, I felt like none of these embodied the character I exuded, so I decided to make and print my own!

I conceptualized and drew the characters and backgrounds on Procreate -- the iPad's most popular drawing app. They were simply different charicaturized versions of myself (and one of a Webtoon character I made).
